...
import '../../../core/services/database/models/playlist_model.dart';
...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
    ...
    properties: <obx_int.ModelProperty>[
      ...
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 1396018584819075936),
        name: 'imagePath',
        type: 9,
        flags: 0,
      ),
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
    entities: _entities,
    lastEntityId: const obx_int.IdUid(1, 4810329605292288283),
...
class PlaylistModel_ {
  ...
  /// See [PlaylistModel.imagePath].
  static final imagePath = obx.QueryStringProperty<PlaylistModel>(
